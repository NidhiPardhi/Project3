...
body {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/subb.png');
	background-size: 100%;
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control s" name="subjectName"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<textarea class="form-control s" name="description"
